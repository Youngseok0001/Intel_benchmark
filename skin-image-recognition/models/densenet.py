...
from models import densenet_utils
...
def densenet121(inputs, num_classes=7, is_training=True, reuse=None):
...
def densenet161(inputs, num_classes=7, is_training=True, reuse=None):
  return densenet(inputs,
                  num_classes=num_classes, 
                  reduction=0.5,
                  growth_rate=48,
...
def densenet169(inputs, num_classes=7, is_training=True, reuse=None):
  return densenet(inputs,
                  num_classes=num_classes, 
                  reduction=0.5,
                  growth_rate=32,
